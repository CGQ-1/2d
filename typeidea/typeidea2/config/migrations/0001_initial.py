# Generated by Django 3.1.6 on 2021-08-21 06:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_type', models.PositiveIntegerField(choices=[(1, 'HTML'), (2, '最新文章'), (3, '最热文章'), (4, '最近评论')], default=1, help_text='展示类型')),
                ('content', models.CharField(blank=True, help_text='如果设置的不是HTML类新，可为空', max_length=50, verbose_name='内容')),
